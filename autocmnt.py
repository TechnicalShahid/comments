...
def main():
    ...
    clear()
    print("Welcome To Technical Shahid (AutoCommenting for Faceboook, WhatsApp, Twitter, Instagram and all social media) Program. All Rights Reserved, 2020.")
    time.sleep(1.5)
    print("")
...
while True:
    ...
    print("Project (AutoCommenting Bot) Done By: Technical Shahid")
    print("Subscribe Technical Shahid on youtube")
    print("Subscribe Technical Shahid on youtube")
    print("Subscribe Technical Shahid on youtube")
    time.sleep(2)
    print("")
